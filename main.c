...
void menu(T_Sala * sala) {
  ...
  switch (opcao) {
    case 1:
      printf("-----------------------------------------------\n");
      printf("Cadastro de alunos e materias\n");
    ...
    case 4:
      ...
      scanf("%d", &rgmRemocao);
      removerAlunoPorRGM(sala, rgmRemocao);  // Chama a função de remoção
      printf("-----------------------------------------------\n");
      printf("Listagem atualizada\n");
      listarALunos(sala); // Listagem atualizada
      menu(sala);
      break;
    case 5:
      printf("-----------------------------------------------\n");
